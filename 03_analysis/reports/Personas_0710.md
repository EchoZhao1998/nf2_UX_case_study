...
- **UPDATE 2026-07-12:** #15 and #27 unreachable (invalid contact info). n=4 is final; confidence caveats above are permanent, not pending. Compensation: survey n=38 role re-cut (quantitative check on proxy-distance) + usability studies (re-test 林悦's consult scenario). State this openly in the case study — lost participants + mitigation reads as method, silence reads as oversight.
