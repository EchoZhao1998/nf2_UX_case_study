...
\begin{figure}[H]\centering\includegraphics[width=\linewidth]{figures/fig1_onboarding_home.png}\par\vspace{0.4em}{\footnotesize\itshape \textbf{Figure 1.} Hi-fidelity draft screens: splash, onboarding with accessibility profile, and the notebook-style home timeline.}\end{figure}

\begin{figure}[H]\centering\includegraphics[width=\linewidth]{figures/fig2_photo_upload.png}\par\vspace{0.4em}{\footnotesize\itshape \textbf{Figure 2.} Hi-fidelity draft screens: "collect first, organise later" — photo capture of paper records and films.}\end{figure}
