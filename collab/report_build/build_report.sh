...
#      ...and writes the result to report_build/_body.md
...
# happens on the temporary _body.md copy.
# =====================================================================
set -euo pipefail
...
SRC="$DVP_DIR/wanting_35507071_DVP_report.md"   # the Markdown you edit
BODY="$BUILD_DIR/_body.md"                       # temporary transformed copy
PDF="$DVP_DIR/Wanting_35507071_DVP_report.pdf"   # the output
...
pandoc "$BODY" \
  ...
  --include-before-body="$BUILD_DIR/titlepage.tex" \
